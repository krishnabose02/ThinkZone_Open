...
export class AppComponent {
  ...
  constructor(
    ...
    console.log('@@@ Get App Name: ' + JSON.stringify(this.appVersion.getAppName()));
    console.log('@@@ Get Package: ' + this.appVersion.getPackageName());
    console.log('@@@ Get Version Code: ' + this.appVersion.getVersionCode());
    console.log('@@@ Get Version Numver: ' + JSON.stringify(this.appVersion.getVersionNumber()));

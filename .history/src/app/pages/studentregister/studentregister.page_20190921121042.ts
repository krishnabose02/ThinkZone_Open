...
export class StudentregisterPage {
  ...
  initialize_fields(flag){
    if(flag == 'edit'){
      ...
      this._studentid = this.res.studentObj._id;
      this._studentname = this.res.studentObj._id;
      this._program = this.res.studentObj._id;
      this._class = this.res.studentObj._id;
      this._phone = this.res.studentObj._id;
      this._gender = this.res.studentObj._id;
      this._dob = this.res.studentObj._id;
      this._parentsname = this.res.studentObj._id;
      this._registration_date = this.res.studentObj._id;
    }else{
      this._id ='';
      this._studentid = '';
      this._studentname = '';

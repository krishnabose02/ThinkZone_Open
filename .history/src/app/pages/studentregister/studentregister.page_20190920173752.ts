...
export class StudentregisterPage {
  ...
  async new_registration(details){
  ...
  async update_registration(details){
    let loading = await this.loadingController.create({});
    await loading.present();
    await this.api.updatestudent('', details)
      .subscribe(res => {
        console.log(res);
        loading.dismiss();
        this.reset();
  ...
  register_button_click(){
    ...
    if(this.studentregister_name == undefined || this.studentregister_name == null || this.studentregister_name == ''){
      ...
      if(this.flag == 'new'){
        this.new_registration(details);
      }else if(this.flag == 'edit'){
        this.update_registration(details);
      }
    }
  }

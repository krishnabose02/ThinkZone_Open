...
export class StudentregisterPage {
  ...
  constructor(
    ...
    if(this.flag == 'new'){
      ...
      this.studentregister_name = this.res.studentObj.studentname;
      this.program = this.res.studentObj.program;
      this.select_program_onchange(this.program);
      this.class = this.res.studentObj.class;
      this.phone = this.res.studentObj.phone;
      this.gender = this.res.studentObj.gender;
      this.dob = this.res.studentObj.dob;
      this.father = this.res.studentObj.parentsname;
      this.regdate = this.res.studentObj.registration_date;
    }
  }

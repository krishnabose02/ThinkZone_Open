...
export class PgassessmentPage {
  ...
  calculatemonth(fromDate, toDate){
    ...
    if(this.month_diff >= 1 && this.month_diff <= 3){
      ...
      const q1 = { value: 'month1', text: 'month 1', disabled: false };
      const q2 = { value: 'month2', text: 'month 2', disabled: true };
      const q3 = { value: 'month3', text: 'month 3', disabled: true };
      const q4 = { value: 'month4', text: 'month 4', disabled: true };
      this.month_list = [];
      this.month_list.push(q1);
      this.month_list.push(q2);
      this.month_list.push(q3);
      this.month_list.push(q4);
    } else if(this.month_diff >= 4 && this.month_diff <= 6){
      console.log('>=4 month_diff <=6');
      const q1 = { value: 'month1', text: 'month 1', disabled: false };
      const q2 = { value: 'month2', text: 'month 2', disabled: false };
      const q3 = { value: 'month3', text: 'month 3', disabled: true };
      const q4 = { value: 'month4', text: 'month 4', disabled: true };
      this.month_list = [];
      this.month_list.push(q1);
      ...
      const q1 = { value: 'month1', text: 'month 1', disabled: false };
      const q2 = { value: 'month2', text: 'month 2', disabled: false };
      const q3 = { value: 'month3', text: 'month 3', disabled: false };
      const q4 = { value: 'month4', text: 'month 4', disabled: true };
      this.month_list = [];
      this.month_list.push(q1);
      this.month_list.push(q2);
      ...
      const q2 = { value: 'month2', text: 'month 2', disabled: false };
      const q3 = { value: 'month3', text: 'month 3', disabled: false };
      const q4 = { value: 'month4', text: 'month 4', disabled: false };
      this.month_list = [];
      this.month_list.push(q1);
      this.month_list.push(q2);
      this.month_list.push(q3);

...
export class AttendancePage {
                ...
                },
                {
                  ...
                  handler: data => {
                    if (data.holiday.length > 0) {
                      ...
                      this.save_attendace_holiday(this.attendance_list);
                    } else {
  ...
  async save_attendace_holiday(attendancelist) {
    console.log('@@@ save_attendace: '+JSON.stringify(attendancelist));
    const loading = await this.loadingController.create({});
    await loading.present();
    await this.api.saveattendance(attendancelist).subscribe(res => {

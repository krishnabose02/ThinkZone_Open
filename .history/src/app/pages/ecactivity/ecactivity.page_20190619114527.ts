...
export class EcactivityPage {
  ...
  async activity_btnclick(activity){
    ...
    this.navController.navigateForward('/ecactivity2', { program: this.program, subject: this.subject, month: this.selected_month, week: this.selected_week, activity: activity });
  }

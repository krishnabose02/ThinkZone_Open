...
export class Ecactivity2Page {
  ...
  constructor(
    ...
    this.file.checkDir(this.file.externalRootDirectory, '/storage/3939-6531/mydir').then(_ => {
      console.log('Directory exists');
      this.showAlert('Directory exists','','Directory exists: '+(this.file.externalRootDirectory));
    }).catch(err =>{
      console.log('Directory doesnt exists');
      this.showAlert('Directory doesnt exists','','Directory doesnt exists: '+(this.file.externalRootDirectory));
    });

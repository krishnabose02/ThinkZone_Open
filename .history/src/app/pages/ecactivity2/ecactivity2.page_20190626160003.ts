...
export class Ecactivity2Page {
  ...
  async open_document(){
    ...
    this.showAlert('file.dataDirectory','',''+this.file.dataDirectory);
    let fakeName = Date.now();
    this.file.copyFile(this.doc_filepath_full, 'test.jpg', this.file.dataDirectory, fakeName+'.jpg').then(result => {

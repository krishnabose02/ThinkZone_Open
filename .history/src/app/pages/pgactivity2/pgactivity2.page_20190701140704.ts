...
export class Pgactivity2Page {
  ...
  async play_video(){
    this.vid_filepath_full = this.sdcard_filepath+'/THINKZONE/PGE/'+this.selected_subject.toLocaleUpperCase()+'/VIDEO/M'+this.selected_month+'_W'+this.selected_week+'_A'+this.selected_activity+'.mp4';
    console.log('### video file path: '+this.vid_filepath_full);
  ...
  async open_document(){
    ...
    console.log('###doc file path: '+this.doc_filepath_full);

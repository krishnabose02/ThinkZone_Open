...
export class Pgactivity2Page {
  ...
  async play_video(){
    this.vid_filepath_full = this.sdcard_filepath+'/THINKZONE/PGE/'+this.selected_subject.toLocaleUpperCase()+'/VIDEO/M'+this.selected_month+'_W'+this.selected_week+'_L'+this.selected_activity+'_1.mp4';

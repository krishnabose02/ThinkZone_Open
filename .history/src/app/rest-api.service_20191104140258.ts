...
export class RestApiService {
  ...
  // get tch assessment
  gettchassessment(preferedlanguage, program, level, stage, subject): Observable<any> {
    this.url = baseUrl + 'gettchassessment/' + preferedlanguage + '/' + program + '/' + level + '/' + stage + '/' + subject;
    this.show(this.url);
    return this.http.get(this.url, httpOptions).pipe(
      map(this.extractData),
      catchError(this.handleError));
  ...
  gettchassessmenttest(studentid, program, level, stage, subject): Observable<any> {
    this.url = baseUrl + 'gettchassessmenttest/' + studentid + '/' + program + '/' + level + '/' + stage + '/' + subject;
    this.show(this.url);
    return this.http.get(this.url, httpOptions).pipe(
      map(this.extractData),
      catchError(this.handleError));
  ...
  getmasteractivitiydetails(preferedlanguage, program, subject, month, week, activity): Observable<any> {
    return this.http.get(baseUrl+ 'getmasteractivitiydetails/'+ preferedlanguage+'/'+program+ '/'+ subject+ '/'+ month+ '/'+ week+ '/'+ activity, httpOptions)
